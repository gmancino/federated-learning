...
for i in range(1, 16):
    ...
    corruption_log_reg = MulticlassLogReg(test_data[0:num_test], y_corrupt, w0, b0, T=1000, tol=0.5, alpha=0.25, lam1=1e-3, lam2=1, num_classes=10)
...
plt.title(str(len(test_label[0:num_test])) + ' data points')
